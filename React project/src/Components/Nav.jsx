...
//               </a>
//             ) : (
//               <a onClick={() => loginWithRedirect()} className="inline-block bg-blue-600 text-white font-semibold py-2 px-4 rounded hover:bg-blue-700 transition duration-300">
...
//       {/* Add margin to the top of the main content to prevent overlap */}
//       <div className="relative isolate px-6 pt-20 lg:px-8"> {/* Increased pt-20 for more spacing */}
//         <div
//           aria-hidden="true"
